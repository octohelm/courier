...
func (t *transformer) EncodeTo(ctx context.Context, w io.Writer, v any) error {
...
func (t *transformer) DecodeFrom(ctx context.Context, r io.ReadCloser, v any, headers ...textproto.MIMEHeader) error {

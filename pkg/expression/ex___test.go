...
func TestExpr(t *testing.T) {
	...
	t.Run("map", func(t *testing.T) {
		...
		t.Run("should pass", func(t *testing.T) {
			ret, _ := e.Exec(context.Background(), map[string]any{
				"1": "111",
				"2": "111",
				"3": "111",
			})
		...
		t.Run("should failed cause map len", func(t *testing.T) {
			ret, _ := e.Exec(context.Background(), map[string]any{
				"1": "111",
				"2": "111",
			})
		...
		t.Run("should failed cause key rule failed", func(t *testing.T) {
			ret, _ := e.Exec(context.Background(), map[string]any{
				"1": "111",
				"2": "11",
				"z": "111",
		...
		t.Run("should failed cause elem rule failed", func(t *testing.T) {
			ret, _ := e.Exec(context.Background(), map[string]any{
				"1": "111",
				"2": "11",
				"3": "111",
